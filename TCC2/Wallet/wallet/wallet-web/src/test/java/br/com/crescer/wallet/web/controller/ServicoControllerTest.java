...
//        Assert.assertEquals(dashboard.getThisMonthAmountExpense(), BigDecimal.valueOf(100));
//        Assert.assertEquals(dashboard.getNextMonthAmountExpense(), BigDecimal.valueOf(100));
