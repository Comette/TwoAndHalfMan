...
//
//import br.com.crescer.wallet.entity.entity.Cotacao;
...
//
//        assertEquals(BigDecimal.valueOf(7).setScale(6,RoundingMode.HALF_UP), service.findLastCurrencyAverage(Coin.AUD));
//        assertEquals(BigDecimal.valueOf(8).setScale(6,RoundingMode.HALF_UP), service.findLastCurrencyAverage(Coin.CAD));
//        assertEquals(BigDecimal.valueOf(9).setScale(6,RoundingMode.HALF_UP), service.findLastCurrencyAverage(Coin.EUR));
//    }
//
//    /**
...
//                assertEquals(BigDecimal.valueOf(7.5).setScale(6, RoundingMode.HALF_UP), service.findLastAverage().get(Coin.BRL));
//                assertEquals(BigDecimal.valueOf(11).setScale(6, RoundingMode.HALF_UP), service.findLastAverage().get(Coin.GBP));
//                assertEquals(BigDecimal.valueOf(10).setScale(6, RoundingMode.HALF_UP), service.findLastAverage().get(Coin.JPY));
//            }
//
//        }
//    }
